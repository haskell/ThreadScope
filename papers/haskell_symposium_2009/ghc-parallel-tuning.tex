...
with multi-core execution support in the runtime.  However, tuning
...
for multi-core programming with GHC.  The system comprises three parts:
...
supports multi-core execution out of the box, including multiple
...
multi-core GHC setting.  Firstly, the trade-offs are likely to be
...
to the file-system once it becomes full, but since the buffer is a
...
slightly faster in parallel now (2.5 compared to 2.4 speedup):
