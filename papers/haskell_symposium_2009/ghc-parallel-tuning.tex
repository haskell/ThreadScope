...
To create two workloads that take roughly the same amount of time to execute we performed some experiments which show that \code{fib 40} takes roughly the same time to execute as \code{sumEuler 7450}.
